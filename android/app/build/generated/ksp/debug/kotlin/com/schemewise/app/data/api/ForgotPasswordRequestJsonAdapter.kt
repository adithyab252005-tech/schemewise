...
public class ForgotPasswordRequestJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<ForgotPasswordRequest>() {
  ...
  public override fun toString(): String = buildString(43) {
      append("GeneratedJsonAdapter(").append("ForgotPasswordRequest").append(')') }

  public override fun fromJson(reader: JsonReader): ForgotPasswordRequest {
  ...
  public override fun toJson(writer: JsonWriter, value_: ForgotPasswordRequest?): Unit {
    if (value_ == null) {
