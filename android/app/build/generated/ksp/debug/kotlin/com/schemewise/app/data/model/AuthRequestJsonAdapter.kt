...
public class AuthRequestJsonAdapter(
  moshi: Moshi,
  ...
  public override fun fromJson(reader: JsonReader): AuthRequest {
  ...
  public override fun toJson(writer: JsonWriter, value_: AuthRequest?): Unit {
    if (value_ == null) {
