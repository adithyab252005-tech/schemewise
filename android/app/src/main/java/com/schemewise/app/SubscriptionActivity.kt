...
class SubscriptionActivity : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    companion object {
        ...
        private const val SUBSCRIPTION_SKU = "schemewise_premium_subscription"
    }
    ...
    private fun initializeViews() {
        ...
        // Show debug button only in debug builds — invisible in release/Play Store
        if (BuildConfig.DEBUG) {
            btnDebugSimulate.visibility = View.VISIBLE
        }
    }
    ...
    private fun setupClickListeners() {
        ...
        btnDebugSimulate.setOnClickListener {
            simulatePurchaseForDebug()
        }
    }

    // Only called in debug builds — skips real billing and grants premium directly
    private fun simulatePurchaseForDebug() {
        Log.d(TAG, "[DEBUG] Simulating successful purchase")
        Toast.makeText(this, "[DEBUG] Simulating purchase...", Toast.LENGTH_SHORT).show()
